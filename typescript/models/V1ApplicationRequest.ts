 ...
 * 
 * @export
 * @interface V1ApplicationRequest
 */
export interface V1ApplicationRequest {
    /**
     * 
     * @type {Array<CommonApplicationComponent>}
     * @memberof V1ApplicationRequest
     */
 ...
 */
export function instanceOfV1ApplicationRequest(value: object): boolean {
    let isInstance = true;
...
export function V1ApplicationRequestFromJSON(json: any): V1ApplicationRequest {
    return V1ApplicationRequestFromJSONTyped(json, false);
}

export function V1ApplicationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1ApplicationRequest {
...
export function V1ApplicationRequestToJSON(value?: V1ApplicationRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
